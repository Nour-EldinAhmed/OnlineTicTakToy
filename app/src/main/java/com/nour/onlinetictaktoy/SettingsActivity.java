...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(this,
                R.layout.spinner_items, Randomfirst);
        ...
        r5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String body = "شارك اللعبة مع أصدقائك  وابدأ اللعب : \n" + "\n" +
                        "https://play.google.com/store/apps/com.nour.onlinetictaktoy";;
        ...
        rootLayout = findViewById(R.id.r6);
...
// make the view visible and start the animation
    ...
    private void feedbacks(){
        ...
        String[] recipients={"noureldin.ahmed2001@gmail.com"};
        intent.putExtra(Intent.EXTRA_EMAIL, recipients);
        intent.putExtra(Intent.EXTRA_SUBJECT,"Tic Tac Toe Feedbacks");
        intent.putExtra(Intent.EXTRA_CC,"noureldin.ahmed2001@gmail.com");
